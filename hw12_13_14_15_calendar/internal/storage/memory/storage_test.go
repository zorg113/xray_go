...
func TestStorage(t *testing.T) {
	t.Run("use storage", func(t *testing.T) {
		data1 := storage.Event{
			ID:          "ABCD",
			Title:       "ToDo: title",
			StartData:   time.Date(1999, time.April, 05, 20, 00, 00, 00, time.UTC),
			EndData:     time.Date(1999, time.April, 05, 22, 00, 00, 00, time.UTC),
		...
		data2 := storage.Event{
			ID:          "ASCD",
			Title:       "ToDSo: title",
			StartData:   time.Date(1099, time.April, 05, 20, 00, 00, 00, time.UTC),
			EndData:     time.Date(1099, time.April, 05, 22, 00, 00, 00, time.UTC),
		...
		data3 := storage.Event{
			ID:          "ASCD",
			Title:       "ToDSo: title",
			StartData:   time.Date(1999, time.August, 05, 20, 00, 00, 00, time.UTC),
			EndData:     time.Date(1999, time.August, 05, 22, 00, 00, 00, time.UTC),
			Description: "Bla Bla Bl",
			OwnerID:     "CCCXC",
			RemindIn:    "02.03.02",
		}
